# family_analysis
This project analyzes survey data from the International Social Survey Programme (ISSP 2022) to examine preferences regarding the ideal number of children.
